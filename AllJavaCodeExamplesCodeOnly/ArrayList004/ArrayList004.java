 ...
 * This program adds in the sorting of the ArrayList using the sort method in
 * the Collections class in Java.  Note the addition of the compareTo method 
...
public class ArrayList004 {
	...
	public static void PrintPayReport(ArrayList A) {
