 ...
 * 7. Undo, Redo, and file properties
...
public class JavaPad extends JFrame implements WindowListener {
	...
	public JavaPad(String[] args) {
		...
		TextEditor.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 14));
	...
	private void createToolBar() {
		...
		ToolbarButton CutTool = new ToolbarButton(new ImageIcon(cl.getResource("CutImage.GIF")), "Cut", 25, 25);
		...
		ToolbarButton CopyTool = new ToolbarButton(new ImageIcon(cl.getResource("CopyImage.GIF")), "Copy", 25, 25);
		...
		ToolbarButton PasteTool = new ToolbarButton(new ImageIcon(cl.getResource("PasteImage.GIF")), "Paste", 25, 25);
		...
		MainTools.add(new JLabel(new ImageIcon(cl.getResource("ToolSeparatorImage.GIF"))));
		MainTools.add(CutTool);
		MainTools.add(CopyTool);
		MainTools.add(PasteTool);
		MainTools.add(new JLabel(new ImageIcon(cl.getResource("ToolSeparatorImage.GIF"))));
		MainTools.add(SelectAllTool);
		MainTools.add(ToggleLineWrapTool);
		MainTools.add(new JLabel(new ImageIcon(cl.getResource("ToolSeparatorImage.GIF"))));
