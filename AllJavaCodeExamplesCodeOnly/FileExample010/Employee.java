 ...
 * so that we can read and write the object contents, Comparable so 
 * that we can use the Collections class to sort the array, and the 
 * overloaded toString method that allows the main program to use a 
 * printline on an Employee Object.
 * Author:  Don Spickler
 * Date: 3/20/2011
 */
