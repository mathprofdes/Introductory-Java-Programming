...
/*-
 * PrintPreview
 * Creates a Print Preview dialog box for the specified print job.
 * The dialog box has features for scaling the view, landscape and
 * portrait selection, page setup and printing.  The content pane
 * uses a border layout that utilizes only the north, south and center,
 * so that inherited classes can use the east and west for option panels.
 * 
 * Author:  Don Spickler
 */
