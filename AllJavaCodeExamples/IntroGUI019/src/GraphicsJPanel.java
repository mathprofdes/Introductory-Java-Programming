...
/*-
 * GraphicsJPanel
 * Freehand drawing panel with color selection and restricted drawing area.  
 * Author:  Don Spickler
 * Date: 7/6/2016
 */
...
public class GraphicsJPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	public void paint(Graphics g) {
		...
		g.drawString("Clear", drawWidth - 47, 333);
	...
	public void mouseDragged(MouseEvent evt) {
		...
		if ((x > 0) && (x < drawWidth - 50) && (y > 0) && (y < drawHeight) && (prevX > 0) && (prevX < drawWidth - 50)
